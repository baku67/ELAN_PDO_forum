...
CREATE DATABASE IF NOT EXISTS `basile_forum` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `basile_forum`;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 CHARSET=utf8 COLLATE=utf8_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=67 CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS `topic` (
  ...
  `lastPostMsg` text CHARACTER SET utf8 COLLATE utf8_general_ci,
...
INSERT INTO `topic` (`id_topic`, `title`, `status`, `creationdate`, `user_id`, `category_id`, `lastPostId`, `lastPostMsg`) VALUES
	...
	(16, 'Test nouveau topic title', 1, '2023-03-28 01:18:42', 1, 1, 62, 'Test'),
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `role` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT 'ROLE_USER',
