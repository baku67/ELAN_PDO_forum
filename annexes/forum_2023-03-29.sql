...
CREATE TABLE IF NOT EXISTS `liking_post` (
  `id_liking` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `post_id` int NOT NULL,
  PRIMARY KEY (`id_liking`),
  KEY `user_id` (`user_id`),
  KEY `post_id` (`post_id`),
...
-- Listage des données de la table basile_forum.liking_post : ~3 rows (environ)
DELETE FROM `liking_post`;
INSERT INTO `liking_post` (`id_liking`, `user_id`, `post_id`) VALUES
	(16, 29, 52),
	(17, 29, 51),
	(18, 29, 16),
	(19, 29, 53);
...
-- Listage des données de la table basile_forum.post : ~14 rows (environ)
DELETE FROM `post`;
...
INSERT INTO `topic` (`id_topic`, `title`, `status`, `creationdate`, `user_id`, `category_id`, `lastPostId`, `lastPostMsg`) VALUES
	(2, 'Les médecins le détestent, la 11ème va vous surprendre', 1, '2023-03-27 09:01:35', 2, 4, NULL, 'fzefzef'),
	(3, 'ChatGPT écrit des articles sur ChatGPT', 1, '2023-03-27 10:30:36', 2, 2, NULL, 'fzefzef'),
	(4, 'ChatGPT: la fin des développeurs Le 15ème va vous surprendre', 0, '2023-03-27 11:02:38', 1, 2, NULL, 'fzefzef'),
	...
	(12, 'testTitle', 0, '2023-03-27 14:32:00', 1, 1, NULL, 'fzefzef'),
	...
	(33, 'Aaa', 1, '2023-03-29 04:17:46', 33, 2, 50, 'Re'),
	(34, 'Topic Basile', 1, '2023-03-29 16:04:51', 29, 4, 53, 'retest');
...
-- Listage des données de la table basile_forum.user : ~2 rows (environ)
DELETE FROM `user`;
INSERT INTO `user` (`id_user`, `username`, `password`, `email`, `role`, `signInDate`, `status`) VALUES
	...
	(31, 'srgqsrg', '$2y$10$v7dODZuV2gPh.zqn4j4b3.xc.YmAI6ofv0hnd/vmzRfJD8wCz95ge', 'test@test.fr', 'ROLE_USER', '2023-03-29 02:53:09', 1),
	(32, 'testt', '$2y$10$nNStNJp3FF4Nt0gElSZY5.j4NT2cYQndAUGRkBEIP4qQKZ6BxgCju', 'testt@testt.fr', 'ROLE_USER', '2023-03-29 02:57:06', 1),
	(33, 'Aaa', '$2y$10$fr1lK0hG.xmOF2ur.qm8VuIBY3uk2pjYJbl19yJ6gTQK3cMJNysUi', 'Aaa@aaa.fr', 'ROLE_USER', '2023-03-29 04:16:33', 1);
