...
-- Listage des données de la table basile_forum.liking_post : ~17 rows (environ)
...
-- Listage des données de la table basile_forum.post : ~21 rows (environ)
DELETE FROM `post`;
INSERT INTO `post` (`id_post`, `text`, `creationdate`, `user_id`, `topic_id`) VALUES
	...
	(62, 'Test', '2023-04-04 20:21:01', 29, 16),
	(63, 'Test 1st msg ', '2023-04-05 01:44:48', 29, 35);
...
-- Listage des données de la table basile_forum.topic : ~12 rows (environ)
DELETE FROM `topic`;
INSERT INTO `topic` (`id_topic`, `title`, `status`, `closedBy`, `creationdate`, `user_id`, `category_id`, `lastPostId`, `lastPostMsg`) VALUES
	(2, 'Les médecins le détestent, la 11ème va vous surprendre', 0, 'admin', '2023-03-27 09:01:35', 2, 4, NULL, 'fzefzef'),
	(3, 'ChatGPT écrit des articles sur ChatGPT', 1, NULL, '2023-03-27 10:30:36', 2, 2, NULL, 'fzefzef'),
	(4, 'ChatGPT: la fin des développeurs Le 15ème va vous surprendre', 1, NULL, '2023-03-27 11:02:38', 1, 2, NULL, 'fzefzef'),
	(9, 'testTitle', 1, NULL, '2023-03-27 14:19:59', 1, 3, NULL, 'fzefzef'),
	(10, 'testLastInsertedId Politique', 1, NULL, '2023-03-27 14:22:43', 1, 4, NULL, 'fzefzef'),
	(11, 'testRedirection', 1, NULL, '2023-03-27 14:23:37', 1, 4, NULL, 'fzefzef'),
	(12, 'testTitle', 1, NULL, '2023-03-27 14:32:00', 1, 1, NULL, 'fzefzef'),
	(13, 'Test Redirection after create', 0, 'admin', '2023-03-27 23:52:17', 1, 1, NULL, 'fzefzef'),
	(16, 'Test nouveau topic title', 1, NULL, '2023-03-28 01:18:42', 1, 1, 62, 'Test'),
	(33, 'Aaa', 0, 'admin', '2023-03-29 04:17:46', 33, 1, 55, 'Test heure publish'),
	(34, 'Topic Basile', 0, NULL, '2023-03-29 16:04:51', 29, 3, 61, 'Jvh'),
	(35, 'Test politique ', 0, 'author', '2023-04-05 01:44:48', 29, 4, 63, 'Test 1st msg ');
...
-- Listage des données de la table basile_forum.user : ~6 rows (environ)
DELETE FROM `user`;
INSERT INTO `user` (`id_user`, `username`, `password`, `email`, `role`, `signInDate`, `status`) VALUES
	...
	(29, 'basile', '$2y$10$xe3SygvizqOUoKAtbF7yD.wbsn054m/Vue1lfDtFS2mOnbrDGjKEO', 'basile08@hotmail.fr', 'ROLE_ADMIN', '2023-03-28 09:05:25', 0),
